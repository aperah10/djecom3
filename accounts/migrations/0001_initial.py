    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(blank=True, default='Jaipur', max_length=200, null=True)),
                ('city', models.CharField(blank=True, max_length=100, null=True)),
                ('pinCode', models.IntegerField(validators=[django.core.validators.RegexValidator('^[1-9]{1}[0-9]{2}\\s{0,1}[0-9]{3}$')])),
                ...
                ('uplod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addressuser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
