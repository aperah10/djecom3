...
class ProductInSave(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    cart_by = models.ForeignKey(
        to=ProductInCart, on_delete=models.CASCADE, null=True, blank=True
    )
...
class Notification(models.Model):
    ...
    sender = models.ForeignKey(
        to=CustomUser, on_delete=models.CASCADE, related_name="sendernoti"
    )
    user = models.ForeignKey(
        to=CustomUser, on_delete=models.CASCADE, related_name="receviernoti"
    )
